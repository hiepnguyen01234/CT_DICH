...
Object* createProgramObject(char *programName) {
  ...
  program->progAttrs = (ProgramAttributes*) malloc(sizeof(ProgramAttributes));  // kind :loai ,attributes :thuoctinh ,scope :vung
...
Object* createParameterObject(char *name, enum ParamKind kind, Object* owner) {
  Object* obj = (Object*) malloc(sizeof(Object));
  strcpy(obj->name, name);    //neu xoa thong tin khoi tao ->xoa dong nay
  obj->kind = OBJ_PARAMETER;    //va ca xoa dong nay
...
void initSymTab(void) {  // khai bao cao ham doc ghi mac dinh
  Object* obj;
  Object* param;
...
// khoi tao va giai phong cac doi tuong