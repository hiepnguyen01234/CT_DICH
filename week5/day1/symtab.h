...
struct VariableAttributes_ {
  ...
  int localOffset;        // offset of the local variable calculated from the base of the stack frame :vi tri tinh tu base cua frame
};
...
struct ProcedureAttributes_ {
  ...
  CodeAddress codeAddress;  //vi tri bat dau khai bao
};
...
struct ProgramAttributes_ {
  struct Scope_ *scope;
  CodeAddress codeAddress; //vi tri bat dau chuong trinh chinh
};
